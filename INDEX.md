...
| `config/sibling-projects.md` | Durable cross-project reference for ChatGPT: all seven sibling repo URLs, the two-tier cadence and fixed visiting order from Meeting #11, and each project's current single-most-actionable next step as of 2026-09-23 |
