...
| `data/scripts/external_hybrid_shift_coupling_v2_substitution_novelty_null_audit.py` | Executes the coupling-v2 protocol; not yet run — pilot calibration and the full sweep are the next cycle's task, kept separate from freezing this design |
