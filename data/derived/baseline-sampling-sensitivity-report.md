...
Does selecting the first 39,026 eligible Latin and Italian tokens create the reported constraint ratios through source-order or document clustering?

## Method

For each corpus, the script measures every full non-overlapping 39,026-token window in source order. It then makes 200 deterministic samples by shuffling whole CoNLL-U sentences without replacement, concatenating them, and trimming only the final sentence to exactly 39,026 tokens. Words and word-internal character order are never altered. Seed family: `20260919`.
...
| Italian | 260,295 | 6 | 0.2310 | 0.2281–0.2430 | 0.2323 ± 0.0007 | 0.2311–0.2336 | 0.2343 | 0.2196 |
...
- The local-constraint gap is not an artifact of taking the first 39,026 tokens from these two pinned corpora.
